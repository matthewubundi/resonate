...
import { Cpu, Mail, Lock, User, ArrowLeft, Check } from 'lucide-react';
                ...
                <Card className="bg-white shadow-xl border-ink/10">
                    ...
                    <CardContent className="space-y-6">
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            <button className="flex items-center justify-center gap-2 h-10 px-4 rounded-lg border border-ink/10 bg-paleslate hover:bg-white hover:border-ink/20 transition-all text-sm font-semibold text-ink">
